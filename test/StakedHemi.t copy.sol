...
//         assertEq(lockedEnd, 0, "Unlock time mismatch");
//         uint256 coolDownPeriodRounded = (coolDownPeriod / WEEK) * WEEK;
//         assertEq(coolDownPeriod, coolDownPeriodRounded, "Cool down period mismatch");
...
//         uint256 bias = slope * coolDownPeriodRounded;
...
//         uint256 veHemiBalance = stakedHemi.balanceOfNFT(tokenId);
//         console.log(" testBalanceOfNFTWithoutCoolDown ~ veHemiBalance:", veHemiBalance);
//         uint256 totalSupply = stakedHemi.totalSupply();
//         console.log(" testBalanceOfNFTWithoutCoolDown ~ totalSupply:", totalSupply);
//         assertEq(veHemiBalance, bias, "veHemi balance mismatch");
...
//         uint256 biasAtStart = slope * coolDownPeriodRounded;
...
//         veHemiBalance = stakedHemi.balanceOfNFT(tokenId);
//         console.log(" testCoolDown ~ veHemiBalance:", veHemiBalance);
//         totalSupply = stakedHemi.totalSupply();
//         assertEq(totalSupply, veHemiBalance, "total supply wrong after 100 days");
//         console.log(" testBalanceOfNFTWithoutCoolDown ~ totalSupply:", totalSupply);
